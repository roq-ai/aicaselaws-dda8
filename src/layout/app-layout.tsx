...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'legal-researcher', 'ai-developer', 'data-analyst'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Ai Model', path: '/ai-models', entity: 'ai_model', service: AccessServiceEnum.PROJECT, icon: FiCpu },
    {
      name: 'Renamedcase',
      path: '/renamedcases',
      entity: 'Renamedcase',
